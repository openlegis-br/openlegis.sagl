...
class SessoesPlenarias(grok.View):
	...
	for item in self.context.zsql.sessao_plenaria_obter_zsql(cod_sessao_plen=id, tip_sessao=tipo, ano_sessao=ano, ind_excluido=0):
	    ...
	    dic['data_abertura'] = DateTime(item.dat_inicio_sessao, datefmt='international').strftime("%Y-%m-%d")
	    dic['hora_abertura'] = str(item.hr_inicio_sessao)
	    dic['data_encerramento'] = DateTime(item.dat_fim_sessao, datefmt='international').strftime("%Y-%m-%d")
	...
	for item in self.context.zsql.sessao_plenaria_obter_zsql(cod_sessao_plen=id, tip_sessao=tipo, ano_sessao=ano, ind_excluido=0):
	    ...
	    if id != '':
			...
			if ordem.cod_parecer != None:
			       ...
			       dic_parecer['data_sessao'] = DateTime(ordem.dat_ordem, datefmt='international').strftime("%Y-%m-%d")
			   ...
			   dic_votacao['data_sessao'] = DateTime(ordem.dat_ordem, datefmt='international').strftime("%Y-%m-%d")
		    ...
		    for expediente in self.context.zsql.expediente_materia_obter_zsql(cod_sessao_plen=item.cod_sessao_plen, ind_excluido=0):
			 ...
			 dic_expediente['data_sessao'] = DateTime(expediente.dat_ordem, datefmt='international').strftime("%Y-%m-%d")
		    ...
		    for leitura in self.context.zsql.materia_apresentada_sessao_obter_zsql(cod_sessao_plen=item.cod_sessao_plen, ind_excluido=0):
			 ...
			 dic_leitura['data_sessao'] = DateTime(leitura.dat_ordem, datefmt='international').strftime("%Y-%m-%d")
