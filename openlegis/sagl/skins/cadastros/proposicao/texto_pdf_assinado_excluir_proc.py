...
# Nome do arquivo PDF
id_texto = f"{cod_proposicao}_signed.pdf"
...
if erro:
    result = {"success": False, "message": "Ocorreu um erro ao excluir o PDF assinado da proposição!"}
else:
    result = {"success": True, "message": "Arquivo PDF assinado excluído com sucesso!"}
